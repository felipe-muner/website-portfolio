...
export const PORTFOLIO: readonly PortfolioGroup[] = [
  ...
  },
  {
    ...
    sites: [
      ...
      { href: "/biosphere/v1", name: "Elements", brand: "Biosphere Land & Ecosystem Studio", detail: "Earth, water, wind & fire — element chapters", cover: "/img/layouts/biosphere-hero.jpg" },
      { href: "/biosphere/v2", name: "Grove", brand: "Biosphere Land & Ecosystem Studio", detail: "Ink-painted bamboo grove, scroll-painting rhythm", cover: "/img/layouts/biosphere-build.jpg" },
      { href: "/biosphere/v3", name: "Masterplan", brand: "Biosphere Land & Ecosystem Studio", detail: "Dark drafting table — contours, sheets & coordinates", cover: "/img/layouts/biosphere-plan.jpg" },
    ],
  },
  {
